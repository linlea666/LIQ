...
## 📝 一句话结论
（必须首先输出，供小白用户快速判断）
格式：**方向判断：看多/看空/震荡（置信度：高/中/低）**
一句话核心理由（30字以内，用最通俗的语言，禁止专业术语）
示例1："**看空（置信度：中）**——大户在高位出货，买盘接不住，短期可能往下走。"
示例2："**看多（置信度：高）**——机构资金连续大量买入，市场信心强，回调就是上车机会。"
示例3："**震荡（置信度：中）**——多空双方都有大资金撑腰，谁也打不过谁，等一方先认输。"
